...
execute_process(
    COMMAND "${CMAKE_COMMAND}" -S "${NUM8LORA_SOURCE_DIR}" -B "${NUM8LORA_TEST_BUILD_DIR}" -DNUM8LORA_BUILD_HOSTED_METADATA=OFF -DNUM8LORA_BUILD_NUM8_ADAPTER=OFF -DCMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION=10.0.22621.0
