...
#define NUM8LORA_API __declspec(dllexport)
#elif defined(__GNUC__) && __GNUC__ >= 4
#define NUM8LORA_API __attribute__((visibility("default")))
#else
#define NUM8LORA_API
#endif
...
NUM8LORA_API uint16_t num8lora_crc16_ccitt_false(const void* data, uint32_t len);

NUM8LORA_API int num8lora_encode_beacon(
    uint8_t* out_buf,
    uint32_t out_cap,
    uint16_t sender_id,
    uint16_t seq,
...
NUM8LORA_API int num8lora_encode_update_request(
    uint8_t* out_buf,
    uint32_t out_cap,
    uint16_t sender_id,
    uint16_t receiver_id,
...
NUM8LORA_API int num8lora_encode_update_data(
    uint8_t* out_buf,
    uint32_t out_cap,
    uint16_t sender_id,
    uint16_t receiver_id,
...
NUM8LORA_API int num8lora_encode_ack(
    uint8_t* out_buf,
    uint32_t out_cap,
    uint16_t sender_id,
    uint16_t receiver_id,
...
NUM8LORA_API int num8lora_encode_nack(
    uint8_t* out_buf,
    uint32_t out_cap,
    uint16_t sender_id,
    uint16_t receiver_id,
...
NUM8LORA_API int num8lora_decode_common_header(
    const uint8_t* buf,
    uint32_t len,
    num8lora_common_header_t* out_hdr);

NUM8LORA_API int num8lora_validate_frame_crc(
    const uint8_t* buf,
    uint32_t len);

NUM8LORA_API int num8lora_decode_beacon(
    const uint8_t* buf,
    uint32_t len,
    num8lora_common_header_t* out_hdr,
    num8lora_beacon_payload_t* out_payload);

NUM8LORA_API int num8lora_decode_update_request(
    const uint8_t* buf,
    uint32_t len,
    num8lora_common_header_t* out_hdr,
    num8lora_update_request_payload_t* out_payload);

NUM8LORA_API int num8lora_decode_update_data_header(
    const uint8_t* buf,
    uint32_t len,
    num8lora_common_header_t* out_hdr,
...
NUM8LORA_API int num8lora_decode_ack(
    const uint8_t* buf,
    uint32_t len,
    num8lora_common_header_t* out_hdr,
    num8lora_ack_payload_t* out_payload);

NUM8LORA_API int num8lora_decode_nack(
    const uint8_t* buf,
    uint32_t len,
    num8lora_common_header_t* out_hdr,
    num8lora_nack_payload_t* out_payload);

NUM8LORA_API int num8lora_validate_update_numbers(
    const num8lora_update_header_t* hdr,
    const uint32_t* remove_numbers,
    const uint32_t* add_numbers,
    uint16_t* out_error_code);

NUM8LORA_API int num8lora_decode_update_numbers(
    const num8lora_update_header_t* hdr,
...
NUM8LORA_API int num8lora_compute_update_payload_crc16(
    const num8lora_update_header_t* hdr,
    const uint32_t* remove_numbers,
    const uint32_t* add_numbers,
    uint16_t* out_crc16);

NUM8LORA_API int num8lora_classify_frame(
    const uint8_t* buf,
    uint32_t len,
...
NUM8LORA_API void num8lora_sender_init(num8lora_sender_ctx_t* ctx, uint16_t sender_id, uint8_t max_retries);
NUM8LORA_API int num8lora_sender_set_update(
    ...
    const uint32_t* add_numbers,
    uint16_t* out_error_code);
NUM8LORA_API int num8lora_sender_build_beacon(num8lora_sender_ctx_t* ctx, uint8_t* out_buf, uint32_t out_cap, uint32_t* out_len);
NUM8LORA_API int num8lora_sender_handle_update_request(
    num8lora_sender_ctx_t* ctx,
    ...
    uint32_t out_cap,
    uint32_t* out_len);
NUM8LORA_API int num8lora_sender_handle_ack_or_nack(
    num8lora_sender_ctx_t* ctx,
    const uint8_t* in_buf,
    uint32_t in_len,
    num8lora_sender_ack_result_t* out_result,
    uint16_t* out_nack_error_code);
NUM8LORA_API int num8lora_sender_on_ack_timeout(
    num8lora_sender_ctx_t* ctx,
    uint8_t* out_update_buf,
    uint32_t out_cap,
    uint32_t* out_len);

NUM8LORA_API void num8lora_receiver_init(
    ...
    uint32_t local_dataset_version,
    uint32_t last_applied_update_id);
NUM8LORA_API int num8lora_receiver_handle_beacon(
    num8lora_receiver_ctx_t* ctx,
    ...
    uint32_t out_cap,
    uint32_t* out_len);
NUM8LORA_API int num8lora_receiver_on_update_timeout(
    num8lora_receiver_ctx_t* ctx,
    uint8_t* out_request_buf,
    uint32_t out_cap,
    uint32_t* out_len);
NUM8LORA_API int num8lora_receiver_validate_update_data(
    num8lora_receiver_ctx_t* ctx,
    ...
    uint32_t* out_add_numbers,
    uint16_t* out_error_code);
NUM8LORA_API int num8lora_receiver_encode_ack(
    num8lora_receiver_ctx_t* ctx,
    uint16_t sender_id,
    uint32_t ack_update_id,
    uint8_t* out_ack_buf,
    uint32_t out_cap,
    uint32_t* out_len);
NUM8LORA_API int num8lora_receiver_encode_nack(
    num8lora_receiver_ctx_t* ctx,
    uint16_t sender_id,
    uint32_t nack_update_id,
    uint16_t error_code,
...
NUM8LORA_API int num8lora_save_receiver_meta(const char* path, uint32_t dataset_version, uint32_t last_applied_update_id);
NUM8LORA_API int num8lora_load_receiver_meta(const char* path, uint32_t* out_dataset_version, uint32_t* out_last_applied_update_id);

#ifdef NUM8LORA_ENABLE_NUM8
#include "num8.h"
NUM8LORA_API int num8lora_apply_update_to_num8(
    ...
    uint16_t* out_error_code);
NUM8LORA_API int num8lora_receiver_apply_update_data_to_num8(
    num8lora_receiver_ctx_t* ctx,
    num8_engine_t* engine,
    const uint8_t* update_buf,
    uint32_t update_len,
